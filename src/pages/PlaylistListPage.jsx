...
export function PlaylistListPage() {
  ...
  const playlists = [...(data?.items || [])].sort((a, b) => {
    ...
    if (sort === 'track') return (b.tracks?.length || 0) - (a.tracks?.length || 0)
      ...
      <div className="container-xxl">
        <div className="d-flex flex-wrap align-items-start justify-content-between gap-3 mb-4">
          <div>
            ...
            <p className="text-secondary mb-0">모든 공개 플레이리스트를 탐색하세요</p>
          </div>
        ...
        {!loading && !error && playlists.length === 0 ? <EmptyView /> : null}
